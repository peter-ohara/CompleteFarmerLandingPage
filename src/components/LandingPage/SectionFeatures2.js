            ...
            <Fragment>
                <Row>
                    <Colxx xxs={{ size: "12", offset: 0 }} lg={{ size: 8, offset: 2 }} className="text-center">
                        <h1><IntlMessages id="lp.featuressection2.title"/></h1>
                      <p>
                        <IntlMessages id="lp.featuressection2.detail"/>
                      </p>
                    </Colxx>
                </Row>
                    ...
                    <Colxx xxs="12" md="6" lg="5" className="d-flex align-items-center">
                        <div className="d-flex">
                            <div className="feature-text-container">
                                <h2><IntlMessages id="lp.featuressection2.title-1"/></h2>
                                <p>
                                    <IntlMessages id="lp.featuressection2.detail-1-1"/><br/><br/>
                                    <IntlMessages id="lp.featuressection2.detail-1-2"/><br/><br/>
                                    <IntlMessages id="lp.featuressection2.detail-1-3"/>
                                </p>
                            </div>
                        </div>
                    </Colxx>
                ...
                <Row className="featur1e-row">
                    ...
                    <Colxx xxs={{ size: 12, order: 1 }} md={{ size: 6, offset: 0, order: 2 }} lg={{ size: 5, offset: 1 }} className="d-flex align-items-center">
                        <div className="d-flex">
                            <div className="feature-text-container">
                                <h2><IntlMessages id="lp.featuressection2.title-2"/></h2>
                                <p>
                                    <IntlMessages id="lp.featuressection2.detail-2-1"/><br/><br/>
                                    <IntlMessages id="lp.featuressection2.detail-2-2"/><br/><br/>
                                    <IntlMessages id="lp.featuressection2.detail-2-3"/>
                                </p>
                            </div>
                        </div>
                    </Colxx>
                ...
                <Row className="feature-row">
                    <Colxx xxs="12" md="6" lg="5" className="d-flex align-items-center">
                        <div className="d-flex">
                            <div className="feature-text-container">
                                <h2><IntlMessages id="lp.featuressection2.title-3"/></h2>
                                <p>
                                    <IntlMessages id="lp.featuressection2.detail-3-1"/><br/><br/>
                                    <IntlMessages id="lp.featuressection2.detail-3-2"/><br/><br/>
                                    <IntlMessages id="lp.featuressection2.detail-3-3"/>
                                 </p>
                            </div>
                        </div>
                    </Colxx>
