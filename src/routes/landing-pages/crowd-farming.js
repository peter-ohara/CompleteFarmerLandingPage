...
import FeaturesSection3 from "Components/LandingPage/SectionFeatures3";
          ...
          <div className="main-container">
            ...
            <div className="content-container" ref={(x) => { this.home = x; }}>
              <div className="section home subpage">
                <Container>
                <SubHero title={messages["lp.crowdfarming.title"]} detail={messages["lp.crowdfarming.detail"]} >
                  <NavLink
                    to="/auth-login"
